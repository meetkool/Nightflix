...
def search_movies(title):
    response = requests.get(f'https://imdb-api.com/en/API/SearchTitle/k_5pjllrms/{title}')
    data = response.json()
...
def get_random_movies():
    response = requests.get('https://imdb-api.com/en/API/MostPopularMovies/k_5pjllrms')
    data = response.json()
