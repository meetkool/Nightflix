...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ylui1y8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ylui1y8.containers.anotherwebservice.com/
...
```
git clone git@github.com:meetkool/container-ylui1y8.git
cd container-ylui1y8
```
...
```
docker attach container-ylui1y8
```
